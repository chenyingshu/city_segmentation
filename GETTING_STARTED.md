...
### Finetuning and Inference Scripts used in StyleCity: 
```bash
# prepare dataset:
# from annotated colored segment images to ade20k and detectron2 indices
cd datasets
python prepare_ade20k_3dcolor_sem_seg.py`
# training
...
# Note: to finetune a model, you can change WEIGHTS location in the config XXX.yaml file

# segment prediction, save grayscale indexed images, and visualized images.
CUDA_VISIBLE_DEVICES=0 python demo.py /
--config-file /mnt/hdd/anh/Mask2Former/c../configs/ade20k/semantic-segmentation/swin/anh_maskformer2_swin_large_IN21k_384_bs16_160k_res640.yaml /
--input ../segmentation_input /
